# P7 — Pressure-Testing AppSec Core (pre-release)

This directory contains the **pre-release** source manuscript and supporting artefacts for Paper 7 (Pressure-Testing AppSec Core: A Design Science Cycle for Bounded-Ontology Evolution Under Heterogeneous Application-Security Sources). The paper itself may undergo revisions until the `v2.0.0` final tag is assigned to the public-repo bundle.
