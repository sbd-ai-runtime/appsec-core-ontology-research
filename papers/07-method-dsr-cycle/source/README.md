...
- `v2.0.0-construction-p7` — paper folder + supporting artefacts scaffolded; source manuscript at Pass 10 state. Lands when scaffold + Cartographer-emitted `paper7` bundle integration + programme-lead Session sync execution complete.
