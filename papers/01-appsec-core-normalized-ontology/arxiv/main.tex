...
threats, and countermeasures. Blanco et al.~{[}8{]} carried out a
systematic review and formal comparison of security ontologies, deriving
the basis for a more integrated security ontology. These works operate
at the broad information security level; AppSec Core is scoped
...
{[}8{]} C. Blanco, J. Lasheras, E. Fernández-Medina, R. Valencia-García,
and A. Toval, ``Basis for an integrated security ontology according to a
systematic review of existing proposals,'' \emph{Computer Standards \&
Interfaces}, vol.~33, no. 4, pp.~372--388, 2011, doi:
10.1016/j.csi.2010.12.002.
